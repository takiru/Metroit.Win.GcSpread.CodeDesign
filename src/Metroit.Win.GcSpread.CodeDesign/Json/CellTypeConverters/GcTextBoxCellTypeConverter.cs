...
namespace Metroit.Win.GcSpread.CodeDesign.Json.CellTypeConverters
{
    ...
    internal class GcTextBoxCellTypeConverter : InputManCellTypeBaseConverter
    {
        ...
        protected override void SerializeProp(JObject propsObj, string[] includeProps)
        {
            ...
            if (includeProps == null || includeProps.Any(x => x.Contains(nameof(GcTextBoxCellType.MaxLengthCodePage))))
            {
                propsObj.Add(new JProperty(nameof(GcTextBoxCellType.MaxLengthCodePage), c.MaxLengthCodePage));
            }
            ...
            if (includeProps == null || includeProps.Any(x => x.Contains(nameof(GcTextBoxCellType.PasswordRevelationMode))))
            {
                propsObj.Add(new JProperty(nameof(GcTextBoxCellType.PasswordRevelationMode), c.PasswordRevelationMode));
            }
        ...
        protected override void DeserializeProp(KeyValuePair<string, JToken> prop)
        {
            ...
            {
                c.PasswordRevelationMode = prop.Value.ToObject<PasswordRevelationMode>();
                return;
            }
