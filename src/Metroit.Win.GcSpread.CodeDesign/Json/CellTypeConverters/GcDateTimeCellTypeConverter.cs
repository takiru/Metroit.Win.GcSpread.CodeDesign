...
namespace Metroit.Win.GcSpread.CodeDesign.Json.CellTypeConverters
{
    ...
    internal class GcDateTimeCellTypeConverter : FieldsEditorControlCellTypeConverter
    {
        ...
        protected override void SerializeProp(JObject propsObj, string[] includeProps)
        {
            ...
            {
                propsObj.Add(new JProperty(nameof(GcDateTimeCellType.DropDown), DateTimeDropDownInfoConverter.Serialize(c.DropDown)));
            }
            ...
            if (includeProps == null || includeProps.Any(x => x.Contains(nameof(GcDateTimeCellType.DropDownPicker))))
            {
                propsObj.Add(new JProperty(nameof(GcDateTimeCellType.DropDownPicker), DateTimeDropDownPickerInfoConverter.Serialize(c.DropDownPicker)));
            }
        ...
        protected override void DeserializeProp(KeyValuePair<string, JToken> prop)
        {
            ...
            {
                DateTimeDropDownInfoConverter.Deserialize(c.DropDown, prop.Value);
                return;
            }
            ...
            {
                DateTimeDropDownPickerInfoConverter.Deserialize(c.DropDownPicker, prop.Value);
                return;
            }
